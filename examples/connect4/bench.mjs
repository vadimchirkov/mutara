// Connect-4 component-search benchmark. New ID + new DB per run.
...
const id = process.argv[2] ?? "c4-comp-v1";
const storage = process.argv[3] ?? "./examples/connect4/learning.db";
