...
import { FEATURES, V2_NAMES } from "./auto2-features.mjs";

export const implementation = {
  game: "tictactoe-auto-v2",
  ...
  files: {
    ...
    "auto2-features.mjs": readFileSync(new URL("./auto2-features.mjs", import.meta.url), "utf8"),
    "auto2.mjs": readFileSync(new URL("./auto2.mjs", import.meta.url), "utf8"),
  },
};
...
const SCREEN_ROUNDS = V2_NAMES.length; // 8 new refinements first
const TOTAL_ROUNDS = SCREEN_ROUNDS + 12; // 20
...
// Handoff by reconstruction: the v1 champion, rebuilt in the v2 version space
// (different implementation id, so lineage restarts with parentId null).
export const v1Champion = () => strategyVersion(INITIAL_PARAMS, null, [
...
export const adapter = {
  implementation: {
    ...implementation,
    adapter: readFileSync(new URL("./auto2.mjs", import.meta.url), "utf8"),
  },
  recovery: "repeatable",
  validatePlan,
...
export function buildAutoPlan({ rounds = TOTAL_ROUNDS, seed = 7919, minimumGain = 0.02, initial = v1Champion(), trainingSeeds, validationSeeds } = {}) {
